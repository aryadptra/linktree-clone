...
const Index = ({ links }) => {
    ...
    const handleStatusChange = (link) => {
        ...
        router.put(route('links.update-status', link.id), {
            is_active: newStatus ? true : false // Update status
        }, {
            preserveScroll: true,
            onSuccess: () => {
                router.reload();
                                            ...
                                            <div className="flex justify-between items-center">
                                                ...
                                                <div className="flex items-center">
                                                    <label className="inline-flex items-center cursor-pointer">
                                                        <input type="checkbox" value="" className="sr-only peer" checked={link.is_active}
                                                            onChange={() => handleStatusChange(link)} // Tambahkan event handler untuk perubahan status
                                                        />
